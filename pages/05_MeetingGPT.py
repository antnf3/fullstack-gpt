...
import os, math, glob, subprocess, streamlit as st
...
Get started by uloading a video file int the sidebar
"""
)
...
if video:
    ...
    with st.status("Loading video...") as status:
        ...
        status.update(label="Extract audio...")
...
"""
        ...
        )  # .content => StrOutputParser 를 사용하면 .content 을 자동으로 처리해준다.
...
with qa_tab:
    retriever = embed_file(transcript_path, file.name)

    docs = retriever.invoke("What is react-native?")
